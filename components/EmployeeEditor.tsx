                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
                      ...
                      <div className={`md:col-span-3 p-10 shadow-sm flex flex-col justify-center min-h-[180px] rounded-2xl ${isDarkMode ? 'bg-[#1e1e1e]' : 'bg-white'}`}>
                          <textarea 
                              ...
                              className={`text-5xl lg:text-6xl font-bold outline-none w-full bg-transparent tracking-tight resize-none overflow-hidden leading-tight ${isDarkMode ? 'text-white placeholder:text-gray-600' : 'text-gray-900 placeholder:text-gray-300'}`}
                              placeholder="NOME"
                              rows={2}
                          />
                      </div>
                      ...
                      <div className={`md:col-span-2 p-8 shadow-sm flex flex-col justify-center gap-8 min-h-[200px] rounded-2xl ${isDarkMode ? 'bg-[#1e1e1e]' : 'bg-white'}`}>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div>
                                  <label className={`block text-sm font-bold mb-3 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Data de Nascimento:</label>
                                  <CustomDatePicker 
                      ...
                      <div className={`md:col-span-2 p-8 shadow-sm flex flex-col justify-center gap-6 min-h-[200px] rounded-2xl ${isDarkMode ? 'bg-[#1e1e1e]' : 'bg-white'}`}>
                          <h4 className={`text-base font-bold flex items-center gap-2 border-b pb-3 ${isDarkMode ? 'text-white border-white/10' : 'text-gray-900 border-gray-100'}`}>
                              <Phone size={18} className="text-blue-500" /> Contatos & Redes Sociais
                          </h4>
                      ...
                      <div className={`p-8 shadow-sm flex flex-col justify-start gap-4 min-h-[200px] rounded-2xl ${isDarkMode ? 'bg-[#1e1e1e]' : 'bg-white'}`}>
                          <h4 className={`text-base font-bold flex items-center gap-2 border-b pb-3 ${isDarkMode ? 'text-white border-white/10' : 'text-gray-900 border-gray-100'}`}>
                              <Award size={18} className="text-yellow-500" /> Marcos & Datas
                          </h4>
                      ...
                      <div className={`md:col-span-3 p-8 shadow-sm flex flex-col gap-5 rounded-2xl ${isDarkMode ? 'bg-[#1e1e1e]' : 'bg-white'}`}>
                          <h4 className={`text-base font-bold flex items-center gap-2 border-b pb-3 ${isDarkMode ? 'text-white border-white/10' : 'text-gray-900 border-gray-100'}`}>
                              <Target size={18} className="text-purple-500" /> Competências & Habilidades
                          </h4>
